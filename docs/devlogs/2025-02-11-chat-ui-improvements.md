...
related_files:
  - docs/backlog/archive/cursor-style-chat-ui.md
...
- `docs/design/design-tokens.md` updated to document success colors as green for explicit feedback.
...
- **docs/backlog/README.md:** Removed cursor-style-chat-ui from Current Backlog; updated chat-rich-markdown-input to reference archive for its requirement.
