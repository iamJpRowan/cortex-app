...
status: considering
themes: [chat-ai]
summary: Hotkey + overlay to start a chat with input, model, and agent selection without opening chat view.
devlogs: [2025-01-27-chat-interface-scoping]
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Chat Quick Launcher
