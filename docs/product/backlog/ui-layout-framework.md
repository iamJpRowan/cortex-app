...
status: considering
themes: [ui-features]
summary: Collapsible/resizable sidebars, tabbed center, extensible component architecture; foundation for drag-and-drop.
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / UI Layout Framework
...
- Follow [Feature Development](../../development/development-patterns/feature-development.md) and [UI guide](../../development/design/ui-guide.md) patterns
...
- [Terminology](../../development/design/terminology.md) - UI terminology and naming conventions
- [UI Guide](../../development/design/ui-guide.md) - Component usage patterns
