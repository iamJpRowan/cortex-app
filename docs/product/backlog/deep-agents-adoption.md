...
status: considering
themes: [chat-ai]
summary: Migrate to LangChain Deep Agents for planning, filesystem, sub-agents, memory; foundation for Custom Agents.
devlogs: [2025-01-21-langchain-integration, 2025-01-31-custom-agents-design]
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Deep Agents Adoption
