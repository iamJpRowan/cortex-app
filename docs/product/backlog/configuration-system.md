---
status: considering
themes: [configuration-extensibility]
summary: User configuration via config files, preferences UI, and runtime overrides; control LLM, tools, and plugin settings.
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Configuration System
...
- Default chat mode (for [Tool Permission System](./tool-permission-system.story.md): mode applied when starting new conversations)
