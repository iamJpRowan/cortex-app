...
status: considering
themes: [chat-ai]
summary: Detect Ollama, connect to server, discover models, set default for LLM operations.
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Ollama Connection Integration
