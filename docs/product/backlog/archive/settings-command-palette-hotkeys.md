---
status: completed
date_archived: 2025-01-25
summary: Settings system, command palette (Kbar), app-level hotkeys; theme in settings.
devlogs: [2025-01-25-settings-command-palette-hotkeys]
---

[Docs](../../../README.md) / [Product](../../README.md) / [Backlog](../README.md) / Archive / Settings, Command Palette & Hotkeys

# Settings, Command Palette & Hotkeys

## Implementation status

Phases 1–6 are implemented. For adding new commands or hotkeys, see **[Commands and Hotkeys](../../../development/feature-guides/commands-and-hotkeys.md)** in the development guide. For adding new settings, see **[Settings](../../../development/feature-guides/settings.md)**.
