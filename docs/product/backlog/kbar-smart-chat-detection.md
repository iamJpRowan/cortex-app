...
status: considering
themes: [chat-ai]
summary: KBar detects long-form questions and offers to start a chat with that text.
devlogs: [2025-01-27-chat-interface-scoping]
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / KBar Smart Chat Detection
