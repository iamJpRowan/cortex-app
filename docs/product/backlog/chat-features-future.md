...
status: considering
themes: [chat-ai]
summary: Future chat ideas (memory, RAG, attachments, feedback, branching) for consideration.
devlogs: [2025-01-31-custom-agents-design]
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Chat Features (Future Considerations)
