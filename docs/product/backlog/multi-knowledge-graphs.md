...
summary: Create and manage multiple Neo4j Knowledge Graphs; switch between them; app reopens last active on startup.
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Multi-Knowledge Graph Support
