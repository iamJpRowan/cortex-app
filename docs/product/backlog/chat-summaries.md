...
status: considering
themes: [chat-ai]
summary: One Markdown summary per conversation; review past chats; agent can discover and use other summaries.
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Chat Summaries
