...
status: considering
themes: [chat-ai]
summary: Persist execution trace (tool calls, durations) so history shows full trace details.
---

[Docs](../../README.md) / [Product](../README.md) / [Backlog](./README.md) / Execution Trace Persistence
