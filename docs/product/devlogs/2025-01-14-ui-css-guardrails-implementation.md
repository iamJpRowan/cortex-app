...
related_files:
  ...
  - docs/development/development-patterns/feature-development.md
...
*Note: The Component Lifecycle doc referenced below was later merged into [Feature Development](../../development/development-patterns/feature-development.md).*
...
- **Design Tokens** (`docs/development/design/design-tokens.md`): Complete reference for all CSS variables with usage examples
- **UI Guide** (`docs/development/design/ui-guide.md`): Component usage patterns, responsive design, composition examples
- **Accessibility** (`docs/development/design/accessibility.md`): A11y checklist, keyboard navigation, ARIA patterns, testing guidelines
- **Component Lifecycle** (`docs/development/design/component-lifecycle.md`): Initialization patterns, cleanup, event management, common pitfalls
...
- `docs/development/design/ui-guide.md`
- `docs/development/design/accessibility.md`
- `docs/development/design/component-lifecycle.md`
- `.stylelintrc.json`
- `.lintstagedrc.json`
- `scripts/validate-design-tokens.js`
- `scripts/validate-accessibility.js`
...
- [Design Tokens Documentation](../../development/design/design-tokens.md)
- [UI Guide](../../development/design/ui-guide.md)
- [Accessibility Guide](../../development/design/accessibility.md)
- [Component Lifecycle Guide](../../development/development-patterns/feature-development.md) (merged into Feature Development)
