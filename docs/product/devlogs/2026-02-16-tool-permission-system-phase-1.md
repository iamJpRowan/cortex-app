...
related_files: [docs/product/backlog/tool-permission-system.md, src/main/services/llm/tools/]
...
- **Adding-a-tool guide:** [adding-a-tool guide](../../development/feature-guides/adding-a-tool.md), linked from the development guide.
