...
- [Feature Development](./feature-development.md) — Success criteria often mention performance
- [Electron Guidance](./electron-guidance.md) — Main/renderer boundaries and IPC
