...
| Prepare a completed phase for review (runner-invoked)     | [create-pr-message.md](./create-pr-message.md)                      |
...
- **[create-pr-message.md](./create-pr-message.md)** — Write the PR body with test steps when all beads in a phase epic are closed. Invoked by the runner.
