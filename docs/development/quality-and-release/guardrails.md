...
- See [UI State Persistence](../feature-guides/ui-state-persistence.md)
...
- [Feature Development](../development-patterns/feature-development.md) - How to implement features within these constraints
- [Electron Guidance](../development-patterns/electron-guidance.md) - Main/renderer patterns that follow these guardrails
