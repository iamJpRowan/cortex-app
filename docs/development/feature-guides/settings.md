...
- Settings file location and override semantics are described in the backlog item **[Settings, Command Palette & Hotkeys](../../product/backlog/archive/settings-command-palette-hotkeys.md)** (archived).
