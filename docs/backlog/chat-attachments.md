...
- **[Cursor-Style Chat UI](./cursor-style-chat-ui.md)** – Full-width layout and multi-line input; the current prompt input satisfies basic multi-line behavior; this item adds attachments to that input.
