...
>(
  (
    ...
    // Helper to toggle the sidebar. Keyboard shortcut is registered via initHotkeys (hotkeys.sidebar).
        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            className={cn(
              ...
              // Remove right border for mobile sidebar
              'border-r-0',
              // Hide button
              '[&>button]:hidden'
            )}
      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ? cn(
                  // Long calc expression needs to stay on one line
                  `
        ...
        <div
          className={cn(
            ...
            // Variant-specific padding and width
            variant === 'floating' || variant === 'inset'
              ? cn(
                  'p-2',
                  // Long calc expression needs to stay on one line
    ...
    return (
      <main
        ...
        className={cn(
          ...
          // Inset variant responsive styles
...
const sidebarMenuButtonVariants = cva(
  cn(
    ...
    // Spacing when menu action exists
