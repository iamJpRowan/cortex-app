...
export function TestPanel(): HTMLElement {
  ...
  async function testEchoTool() {
    ...
    try {
      const result = await window.api.llm.toolsTest('echo', { message: 'Hello from TestPanel!' })
            ...
            <div className="space-y-2">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-border-primary rounded-md bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-accent-primary"
